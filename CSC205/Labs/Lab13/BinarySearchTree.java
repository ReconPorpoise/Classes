...
// the use of the constructors from BinaryTreeBasis
  ...
  private boolean duplicateCheck (TreeNode t1, TreeNode t2)
  {
	...
	{
		KeyedItem temp1 = (KeyedItem) t1.getItem();
		KeyedItem temp2 = (KeyedItem) t2.getItem();
		if (temp1.getKey() == temp2.getKey()) 
		{
			return (duplicateCheck(t1.getLeft(), t2.getLeft()) &&
				duplicateCheck(t1.getRight(), t2.getRight()) );
		}
		else 
		{
			return false;
