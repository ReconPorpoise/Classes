...
{
	// checks if the time unit is > 1pm (13), if it is, convert that 24 hours time to 12 hour by subtracting 12.
	// else, print 0 and append the time. eg. 8, 0, 0 --> 08:00:00
	// This is done for hrs, mins, and secs.
	bool am;
	int tempHrs;
	...
	if( secs < 10 )
		cout << '0';
	cout << secs; 
	// if am is true, append AM to the time, else append PM
	if( am )
		cout << " AM";
	else 
		cout << " PM";
...
{
	// check certain time points against the input time. If they match any, print what meal they should have.
